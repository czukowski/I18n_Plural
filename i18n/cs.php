...
return array(
	...
	'valid' => array(
		...
		'decimal' => array(
			...
			'other'		=> 'Do pole :field musíte zadat číslo s :param1 desetinnými místy',
		),
		...
		'equals'		=> 'Pole :field se musí rovnat :param1',
		'exact_length' => array(
			'one'		=> 'Pole :field musí být dlouhé přesně 1 znak',
			'few'		=> 'Pole :field musí být přesně :param1 znaky dlouhé',
			'other'		=> 'Pole :field musí být přesně :param1 znaků dlouhé',
		),
		'in_array'		=> 'Do pole :field musíte vložit pouze jednu z dovolených možností',
		'ip'			=> 'Do pole :field musíte zadat platnou ip adresu',
		'match'			=> 'Pole :field se musí shodovat s polem :param1',
		'max_length' => array(
			'few'		=> 'Pole :field musí být nanejvýš :param1 znaky dlouhé',
			'other'		=> 'Pole :field musí být nanejvýš :param1 znaků dlouhé',
		),
		'min_length' => array(
			'one'		=> 'Pole :field musí být alespoň jeden znak dlouhé',
			'few'		=> 'Pole :field musí být alespoň :param1 znaky dlouhé',
			'other'		=> 'Pole :field musí být alespoň :param1 znaků dlouhé',
		),
		...
		'range'			=> 'Hodnota pole :field musí ležet v intervalu od :param1 do :param2',
