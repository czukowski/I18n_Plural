...
return array(
	...
	'valid' => array(
		...
		'decimal' => array(
			'one'		=> 'Поле :field должно содержать число с :param1 десятичным местом',
			'other'		=> 'Поле :field должно содержать число с :param1 десятичными местами',
		),
		'digit'			=> 'Поле :field должно содержать целое число',
		'email'			=> 'Поле :field должно содержать ардес электронной почты',
		'email_domain'	=> 'Поле :field должно содержать действительный ардес электронной почты',
		'equals'		=> 'Значение поля :field должно быть равно :param1',
		'exact_length' => array(
			'one'		=> 'Поле :field должно быть длиной в :param1 знак',
			'few'		=> 'Поле :field должно быть длиной в :param1 знака',
			'other'		=> 'Поле :field должно быть длиной в :param1 знаков',
		),
		'in_array'		=> 'Поле :field должно содержать один из вариантов на выбор',
		'ip'			=> 'Поле :field должно содержать действительный ip адрес',
		'match'			=> 'Поле :field должно быть равно значению поля :param1',
		'max_length' => array(
			'one'		=> 'Поле :field должно иметь длину максимально :param1 знак',
			'few'		=> 'Поле :field должно иметь длину максимально :param1 знака',
			'other'		=> 'Поле :field должно иметь длину максимально :param1 знаков',
		),
		'min_length' => array(
		...
		'range'			=> 'Величина поля :field должна быть в интервале между :param1 и :param2',
