...
return array(
	...
	'valid' => array(
		...
		'max_length' => array(
			'one'		=> 'Поле :field должно иметь длину максимально :param2 знак',
			'few'		=> 'Поле :field должно иметь длину максимально :param2 знака',
			'other'		=> 'Поле :field должно иметь длину максимально :param2 знаков',
		),
		'min_length' => array(
